...
- de.De Mercredi **11** à Vendredi **13 juin** : soutenances

de.De plus, il y aura un rendu hebdomadaire avant chaque **dimanche, minuit**.
...
- Il s'agit d'une version très simplifiée de donjon.Donjon et Dragon. Il peut être tentant d'améliorer le projet et d'intégrer beaucoup de fonctionnalités et règles du jeu originel. Cependant cela ne vous permettra pas d'augmenter votre note. Ne négligez pas le projet de base ni les projets des autres modules. Vous aurez tout le loisir d'améliorer le projet durant votre été.
